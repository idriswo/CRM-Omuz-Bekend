...
export const getAvans = async (req: Request, res: Response) => {
...
export const deleteAvans = async (req: Request, res: Response) => {
  await prisma.avans.delete({ where: { id: Number(req.params.id) } });
