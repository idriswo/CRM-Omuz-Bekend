 ...
 * Ба gateway-и SMS ин шаклҳоро фиристодан маънӣ надорад — рад мешаванд.
 *
 * Инчунин User.phone логини вуруд аст, бинобар ин ҳам ҳангоми сабт, ҳам
 * ҳангоми ҷустуҷӯи корбар ҳамин функсия истифода мешавад — то корбар
 * рақамашро дар ҳар шакл нависад ва ҳамон корбар пайдо шавад.
 */
